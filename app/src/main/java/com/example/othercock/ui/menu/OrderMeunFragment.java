...
import com.example.othercock.adapter.OtherAdapter;
import com.example.othercock.ui.other.PopuMenu;

import java.util.ArrayList;

public class OrderMeunFragment extends Fragment {
    RecyclerView recyclerView;
    LinearLayoutManager linearLayoutManager;
    User user;
    ArrayList<OrderMenu> menuArrayList = new ArrayList<>();
    ArrayList<PopuMenu> menuList = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        for (int i = 0; i < menuArrayList.size(); i++) {
            menuList.add(new PopuMenu(menuArrayList.get(i).getName(), getImage(menuArrayList.get(i).getNumber())));
        }

        recyclerView.setLayoutManager(new LinearLayoutManager(container.getContext()));
        OtherAdapter adapter = new OtherAdapter(menuList, root.getContext());
